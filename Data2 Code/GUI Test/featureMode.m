function []=featureMode(source,cbdata,featureName,modeName,mAxes,mPlots,mControls,mParams)
...
elseif strcmp(modeName,'Update') == 1
    % To be filled
    fprintf(['Update is called by ' featureName '!\n'])
elseif strcmp(modeName,'Move') == 1
    % To be filled
    fprintf(['Move is called by ' featureName '!\n'])
end