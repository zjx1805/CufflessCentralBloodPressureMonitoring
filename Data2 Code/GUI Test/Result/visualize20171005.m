% This code is used to visualize how features (including PTTs/PAT/IJ) from
% each single beat looks like with respect to time/magnitude. Choose the
% feature you would like to visualize by checking the checkbox before it.
% There are two sliders in the bottom that you could use. The upper slider
% sets the limit of the feature magnitude in the DP plot below which
% features will be shown. The lower slider sets the limit of the feature
% timing in the DP plot before which features will be shown. Choose the
% subject you want to visualize by uncommenting the proper line at the very
